<template >
    <section class="relative  overflow-hidden" id="services">
        <div class="relative z-10 max-w-8xl mx-auto sm:px-6 lg:px-8">
            <div class="text-center m-16" data-aos="fade-up">
                ...
                <p class="text-blue-200 text-lg max-w-2xl mx-auto"
                  data-aos-delay="100">
                I provide end-to-end development solutions tailored to your business needs — 
                from intuitive frontend interfaces to powerful backend systems
                </p>
            </div>
            ...
            hover:-translate-y-2"
            >
              <div class="absolute insert-0 bg-linear-to-r from-blue-500/5 
            ...
            group-hover:translate-x-0 transition-all duration-300">
                <ArrowRightIcon class="w-4 h-4 text-white
                 m-auto transform group-hover:translate-x-1
            ...
            data-aos-delay="800">
                ...
                items-center">
                    ...
                    border-blue-400 text-blue-400 font-semi-bold
...
import { 
    ...
    ComputerDesktopIcon} from '@heroicons/vue/16/solid';
...
const services = ref([
    ...
    {   
        ...
        desc: 'Crafting responsive and visually appealing user interfaces using Vue.js, React, or Angular.',
    ...
    {   
        ...
        desc: 'Building robust server-side applications with Node.js, Express, or Django.',
    ...
    },
    {
        ...
        desc: 'Delivering complete web solutions by integrating frontend and backend technologies seamlessly.',
    ...
    },
    {
        ...
        desc: 'Creating cross-platform mobile applications using React Native ',
